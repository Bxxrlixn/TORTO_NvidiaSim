...
class AnglesToJointState(Node):
    ...
    def callback_TORTO_Motor_Angles(self, msg):
        ...
        self.joint_state.position = [
            msg.theta_deg_fl_detoid, msg.theta_deg_fr_detoid, msg.theta_deg_bl_detoid, msg.theta_deg_br_detoid,
            msg.theta_deg_fl_femur, msg.theta_deg_fr_femur, msg.theta_deg_bl_femur, msg.theta_deg_br_femur,
            msg.theta_deg_fl_tibia, msg.theta_deg_fr_tibia, msg.theta_deg_bl_tibia, msg.theta_deg_br_tibia
        ]
