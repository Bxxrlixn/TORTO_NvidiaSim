...
static const _TortoSimReset_type_support_symbol_names_t _TortoSimReset_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, torto_interfaces, msg, TortoSimReset)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, torto_interfaces, msg, TortoSimReset)),
  }
};
...
{
  return &::torto_interfaces::msg::rosidl_typesupport_cpp::TortoSimReset_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, torto_interfaces, msg, TortoSimReset)() {
  return get_message_type_support_handle<torto_interfaces::msg::TortoSimReset>();
}
